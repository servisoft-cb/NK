...
begin
  ...
  Dm1.tOrdemCompra.FindKey([fNotaEntrada.CurrencyEdit11.Value]);
  Dm1.tOrdemCompraItem.IndexFieldNames := 'Codigo;Item';
  Dm1.tOrdemCompraItem.FindKey([fNotaEntrada.CurrencyEdit11.Value,fNotaEntrada.CurrencyEdit12.Value]);
