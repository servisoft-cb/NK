...
uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs, ExtCtrls, StdCtrls, Buttons, DBCtrls, ComCtrls, Menus, RXCtrls, Printers,
  Db, DBTables, RxLookup, rsDBUtils;
...
procedure TfPrevContas.FormCreate(Sender: TObject);
begin
