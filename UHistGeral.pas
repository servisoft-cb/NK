...
type
  TfHistGeral = class(TForm)
    ...
    qClientelkNomeGrupo: TStringField;
    mClienteCodGrupo: TIntegerField;
    mClienteCodAgrupado: TStringField;
    qPedidoCliProdCodGrupo: TIntegerField;
    mClienteProdCodGrupo: TIntegerField;
    mClienteProdCodAgrupado: TStringField;
    qClienteProdCodGrupo: TIntegerField;
    qClienteProdlkNomeGrupo: TStringField;
    qPedidoCliProdNomeCliente: TStringField;
    qPedidoCliProdFantasia: TStringField;
    qPedidoCliProdlkNomeGrupo: TStringField;
    qPedidoCliProdMesCodGrupo: TIntegerField;
    qPedidoCliProdMeslkNomeGrupo: TStringField;
    qClienteProdMesCodGrupo: TIntegerField;
    qClienteProdMeslkNomeGrupo: TStringField;
    ...
    qClienteProdCorCodGrupo: TIntegerField;
    qClienteProdCorlkNomeGrupo: TStringField;
    mClienteProdCorCodGrupo: TIntegerField;
    mClienteProdCorCodAgrupado: TStringField;
    qClienteMesCodGrupo: TIntegerField;
    qClienteMeslkNomeGrupo: TStringField;
    qPedidoCliMesCodGrupo: TIntegerField;
    ...
    qPedidoCliMeslkNomeGrupo: TStringField;
    BitBtn21: TBitBtn;
    ...
    qPedidoProdMesCliCodGrupo: TIntegerField;
    qProdutoMesCliCodGrupo: TIntegerField;
    ...
    mDevMensal: TClientDataSet;
    mDevMensalVlrDevolucao: TFloatField;
    mDevMensalData: TStringField;
    ...
    procedure mDevMensalNewRecord(DataSet: TDataSet);
  private
...
begin
  ...
  qPedidoCliProd.SQL.Add('   INNER JOIN "dbProduto.DB" Dbproduto');
  ...
  //  qPedidoCliProd.SQL.Add('  AND (dbPedidoItem.MateriaPrima = False) ');
  ...
  if DateEdit1.Date > 0 then
    begin
      qPedidoCliProd.SQL.Add('  AND (dbPedidoItem.DtReprogramacao >= :DtReprogramacaoIni)');
      qPedidoCliProd.ParamByName('DtReprogramacaoIni').AsDate := DateEdit1.Date;
    end;
  if DateEdit2.Date > 0 then
    begin
      qPedidoCliProd.SQL.Add('  AND (dbPedidoItem.DtReprogramacao <= :DtReprogramacaoFin)');
  ...
  if RxDBLookupCombo5.Text <> '' then
    begin
      qPedidoCliProd.SQL.Add('  AND (dbCliente.CodGrupo = :CodGrupo)');
      qPedidoCliProd.ParamByName('CodGrupo').AsInteger := RxDBLookupCombo5.KeyValue;
    end;
...
begin
  ...
  qPedidoCliProdMes.SQL.Add('SELECT DbpedidoItem.CodProduto, Dbpedidoitem.DtReprogramacao, DbPedido.CodCliente, SUM( Dbpedidoitem.QtdPares ) QtdPares, SUM( Dbpedidoitem.QtdParesRest ) QtdParesRest, ');
  ...
  //if not CheckBox4.Checked then
  //  qPedidoCliProdMes.SQL.Add('  AND (dbPedidoItem.MateriaPrima = False) ');
  if RxDBLookupCombo2.Text <> '' then
    begin
  ...
  if DateEdit1.Date > 0 then
    begin
      qPedidoCliProdMes.SQL.Add('  AND (dbPedidoItem.DtReprogramacao >= :DtReprogramacaoIni)');
      qPedidoCliProdMes.ParamByName('DtReprogramacaoIni').AsDate := DateEdit1.Date;
    end;
  if DateEdit2.Date > 0 then
    begin
      qPedidoCliProdMes.SQL.Add('  AND (dbPedidoItem.DtReprogramacao <= :DtReprogramacaoFin)');
  ...
  if RxDBLookupCombo5.Text <> '' then
    begin
      qPedidoCliProdMes.SQL.Add('  AND (dbCliente.CodGrupo = :CodGrupo)');
      qPedidoCliProdMes.ParamByName('CodGrupo').AsInteger := RxDBLookupCombo5.KeyValue;
    end;
...
begin
  ...
  qClienteProdMes.SQL.Add('WHERE  (Dbnotafiscalitens.GeraDupl = TRUE) ');
  ...
  if not CheckBox4.Checked then
    qClienteProdMes.SQL.Add('  AND (DbnotafiscalItens.Material = False) ');
  if RxDBLookupCombo2.Text <> '' then
    begin
  ...
  if RxDBLookupCombo5.Text <> '' then
    begin
      qClienteProdMes.SQL.Add('  AND (dbCliente.CodGrupo = :CodGrupo)');
      qClienteProdMes.ParamByName('CodGrupo').AsInteger := RxDBLookupCombo5.KeyValue;
    end;
...
begin
  ...
  qPedidoProdMes.SQL.Add('SELECT DbpedidoItem.CodProduto, Dbpedidoitem.DtReprogramacao, SUM( Dbpedidoitem.QtdPares ) QtdPares, SUM( Dbpedidoitem.QtdParesRest ) QtdParesRest, SUM( Dbpedidoitem.QtdParesCanc ) QtdParesCanc');
  ...
  if RxDBLookupCombo5.Text <> '' then
    begin
      qPedidoProdMes.SQL.Add('   INNER JOIN "dbCliente.DB" DbCliente');
      qPedidoProdMes.SQL.Add('   ON  (DbCliente.Codigo = Dbpedido.CodCliente)');
    end;
  qPedidoProdMes.SQL.Add('WHERE (0=0) ');
  //if not CheckBox4.Checked then
  //  qPedidoProdMes.SQL.Add('  AND (dbPedidoItem.MateriaPrima = False) ');
  if RxDBLookupCombo2.Text <> '' then
    begin
  ...
  if DateEdit1.Date > 0 then
    begin
      qPedidoProdMes.SQL.Add('  AND (dbPedidoItem.DtReprogramacao >= :DtReprogramacaoIni)');
      qPedidoProdMes.ParamByName('DtReprogramacaoIni').AsDate := DateEdit1.Date;
    end;
  if DateEdit2.Date > 0 then
    begin
      qPedidoProdMes.SQL.Add('  AND (dbPedidoItem.DtReprogramacao <= :DtReprogramacaoFin)');
  ...
  if RxDBLookupCombo5.Text <> '' then
    begin
      qPedidoProdMes.SQL.Add('   AND (dbCliente.CodGrupo = :CodGrupo)');
      qPedidoProdMes.ParamByName('CodGrupo').AsInteger := RxDBLookupCombo5.KeyValue;
    end;
   qPedidoProdMes.SQL.Add('GROUP BY Dbpedidoitem.CodProduto, Dbpedidoitem.DtReprogramacao');
  qPedidoProdMes.Open;
end;
...
begin
  ...
  qPedidoProdMesCli.SQL.Add('SELECT dbPedido.CodCliente, DbpedidoItem.CodProduto, Dbpedidoitem.DtReprogramacao, SUM( Dbpedidoitem.QtdPares ) QtdPares, ');
  ...
  //if not CheckBox4.Checked then
  //  qPedidoProdMesCli.SQL.Add('  AND (dbPedidoItem.MateriaPrima = False) ');
  if RxDBLookupCombo2.Text <> '' then
    begin
  ...
  if DateEdit1.Date > 0 then
    begin
      qPedidoProdMesCli.SQL.Add('  AND (dbPedidoItem.DtReprogramacao >= :DtReprogramacaoIni)');
      qPedidoProdMesCli.ParamByName('DtReprogramacaoIni').AsDate := DateEdit1.Date;
    end;
  if DateEdit2.Date > 0 then
    begin
      qPedidoProdMesCli.SQL.Add('  AND (dbPedidoItem.DtReprogramacao <= :DtReprogramacaoFin)');
  ...
  if RxDBLookupCombo5.Text <> '' then
    begin
      qPedidoProdMesCli.SQL.Add('  AND (dbCliente.CodGrupo = :CodGrupo)');
      qPedidoProdMesCli.ParamByName('CodGrupo').AsInteger := RxDBLookupCombo5.KeyValue;
    end;
...
begin
  ...
  if RxDBLookupCombo5.Text <> '' then
    begin
      qProdutoMes.SQL.Add('   INNER JOIN "dbCliente.DB" DbCliente');
      qProdutoMes.SQL.Add('   ON  (DbCliente.Codigo = DbNotaFiscal.CodCli)');
    end;
  qProdutoMes.SQL.Add('WHERE (Dbnotafiscalitens.GeraDupl = TRUE) ');
  ...
  if RxDBLookupCombo5.Text <> '' then
    begin
      qProdutoMes.SQL.Add('  AND (dbCliente.CodGrupo = :CodGrupo)');
      qProdutoMes.ParamByName('CodGrupo').AsInteger := RxDBLookupCombo5.KeyValue;
    end;
...
begin
  ...
  qProdutoMesCli.SQL.Add('WHERE (Dbnotafiscalitens.GeraDupl = TRUE) ');
  ...
  if RxDBLookupCombo5.Text <> '' then
    begin
      qProdutoMesCli.SQL.Add('  AND (dbCliente.CodGrupo = :CodGrupo)');
      qProdutoMesCli.ParamByName('CodGrupo').AsInteger := RxDBLookupCombo5.KeyValue;
    end;
...
begin
  ...
  qPedidoProd.SQL.Add('   INNER JOIN "dbProduto.DB" Dbproduto');
  qPedidoProd.SQL.Add('   ON  (Dbpedidoitem.CodProduto = Dbproduto.Codigo)');
  if RxDBLookupCombo5.Text <> '' then
    begin
      qPedidoProd.SQL.Add('   INNER JOIN "dbCliente.DB" DbCliente');
      qPedidoProd.SQL.Add('   ON  (DbCliente.Codigo = Dbpedido.CodCliente)');
    end;
  qPedidoProd.SQL.Add('WHERE (0=0) ');
  //if not CheckBox4.Checked then
  //  qPedidoProd.SQL.Add('  AND (dbPedidoItem.MateriaPrima = False) ');
  if RxDBLookupCombo2.Text <> '' then
    begin
  ...
  if DateEdit1.Date > 0 then
    begin
      qPedidoProd.SQL.Add('  AND (dbPedidoItem.DtReprogramacao >= :DtReprogramacaoIni)');
      qPedidoProd.ParamByName('DtReprogramacaoIni').AsDate := DateEdit1.Date;
    end;
  if DateEdit2.Date > 0 then
    begin
      qPedidoProd.SQL.Add('  AND (dbPedidoItem.DtReprogramacao <= :DtReprogramacaoFin)');
  ...
  if RxDBLookupCombo5.Text <> '' then
    begin
      qPedidoProd.SQL.Add('  AND (dbCliente.CodGrupo = :CodGrupo)');
      qPedidoProd.ParamByName('CodGrupo').AsInteger := RxDBLookupCombo5.KeyValue;
    end;
...
begin
  ...
  qPedidoCliMes.SQL.Add('SELECT Dbpedido.CodCliente, Dbpedidoitem.DtReprogramacao, SUM( Dbpedidoitem.QtdPares ) QtdPares, SUM( Dbpedidoitem.QtdParesRest ) QtdParesRest, ');
  ...
  //if not CheckBox4.Checked then
  //  qPedidoCliMes.SQL.Add('  AND (dbPedidoItem.MateriaPrima = False) ');
  if RxDBLookupCombo2.Text <> '' then
    begin
  ...
  if DateEdit1.Date > 0 then
    begin
      qPedidoCliMes.SQL.Add('  AND (dbPedidoItem.DtReprogramacao >= :DtReprogramacaoIni)');
      qPedidoCliMes.ParamByName('DtReprogramacaoIni').AsDate := DateEdit1.Date;
    end;
  if DateEdit2.Date > 0 then
    begin
      qPedidoCliMes.SQL.Add('  AND (dbPedidoItem.DtReprogramacao <= :DtReprogramacaoFin)');
  ...
  if RxDBLookupCombo5.Text <> '' then
    begin
      qPedidoCliMes.SQL.Add('  AND (dbCliente.CodGrupo = :CodGrupo)');
      qPedidoCliMes.ParamByName('CodGrupo').AsInteger := RxDBLookupCombo5.KeyValue;
    end;
...
begin
  ...
  if not CheckBox4.Checked then
    qNotas.SQL.Add('  AND (dbNotaFiscalItens.Material = False) ');
  if RxDBLookupCombo2.Text <> '' then
    begin
...
begin
  ...
  qVendedor.SQL.Add('WHERE (Dbnotafiscalitens.GeraDupl = TRUE) ');
...
begin
  ...
  qClienteProdCor.SQL.Add('   INNER JOIN "dbProduto.DB" Dbproduto');
  qClienteProdCor.SQL.Add('   ON  (Dbnotafiscalitens.CodProduto = Dbproduto.Codigo)');
  qClienteProdCor.SQL.Add('WHERE (Dbnotafiscalitens.GeraDupl = TRUE) ');
  ...
  if RxDBLookupCombo5.Text <> '' then
    begin
      qClienteProdCor.SQL.Add('  AND (dbCliente.CodGrupo = :CodGrupo)');
      qClienteProdCor.ParamByName('CodGrupo').AsInteger := RxDBLookupCombo5.KeyValue;
    end;
...
begin
  ...
  if RxDBLookupCombo5.Text <> '' then
    begin
      qProduto.SQL.Add('   INNER JOIN "dbCliente.DB" DbCliente');
      qProduto.SQL.Add('   ON  (dbCliente.Codigo = DbNotaFiscal.CodCli)');
    end;
  qProduto.SQL.Add('WHERE (Dbnotafiscalitens.GeraDupl = TRUE) ');
  ...
  if RxDBLookupCombo5.Text <> '' then
    begin            
      qProduto.SQL.Add('  AND (dbCliente.CodGrupo = :CodGrupo)');
      qProduto.ParamByName('CodGrupo').AsInteger := RxDBLookupCombo5.KeyValue;
    end;
...
begin
  ...
  qClienteMes.SQL.Add('WHERE (Dbnotafiscalitens.GeraDupl = TRUE) ');
  ...
  if RxDBLookupCombo5.Text <> '' then
    begin
      qClienteMes.SQL.Add('  AND (dbCliente.CodGrupo = :CodGrupo)');
      qClienteMes.ParamByName('CodGrupo').AsInteger := RxDBLookupCombo5.KeyValue;
    end;
...
begin
  ...
  qClienteProd.SQL.Add('   INNER JOIN "dbProduto.DB" Dbproduto');
  qClienteProd.SQL.Add('   ON  (Dbnotafiscalitens.CodProduto = Dbproduto.Codigo)');
  qClienteProd.SQL.Add('WHERE  (Dbnotafiscalitens.GeraDupl = TRUE) ');
  ...
  if RxDBLookupCombo5.Text <> '' then
    begin
      qClienteProd.SQL.Add('  AND (dbCliente.CodGrupo = :CodGrupo)');
      qClienteProd.ParamByName('CodGrupo').AsInteger := RxDBLookupCombo5.KeyValue;
    end;
...
begin
  ...
  qFaturamento.SQL.Add('SELECT SUM( Dbnotafiscalitens.VlrTotal ) VlrTotal, dbNotaFiscal.PercDesc, dbNotaFiscal.DtEmissao');
  ...
  qFaturamento.SQL.Add('WHERE  (Dbnotafiscalitens.GeraDupl = TRUE) ');
  ...
  qFaturamento.SQL.Add('GROUP BY dbNotaFiscal.PercDesc, dbNotaFiscal.DtEmissao');
  qFaturamento.Open;
  vVlrFat := 0;
  qFaturamento.First;
...
begin
  ...
  qCliente.SQL.Add('WHERE  (Dbnotafiscalitens.GeraDupl = TRUE) ');
  ...
  if RxDBLookupCombo5.Text <> '' then
    begin
      qCliente.SQL.Add('  AND (dbCliente.CodGrupo = :CodGrupo)');
      qCliente.ParamByName('CodGrupo').AsInteger := RxDBLookupCombo5.KeyValue;
    end;
...
procedure TfHistGeral.RxDBLookupCombo2Change(Sender: TObject);
begin
  qFaturamento.Close;
  CurrencyEdit1.Clear;
end;
...
begin
  mFatMensalVlrFaturamento.AsFloat;
end;
...
procedure TfHistGeral.mDevMensalNewRecord(DataSet: TDataSet);
begin
  mDevMensalVlrDevolucao.AsFloat := 0;
end;
