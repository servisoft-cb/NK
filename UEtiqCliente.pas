...
uses UDM1, UEscImpressora, UQuant, UCliente;
...
begin
  if tAuxEtiquetalkBairro.AsString <> '' then
    begin
      if (tAuxEtiquetaCodigo.AsInteger = 2675) or (tAuxEtiquetaCodigo.AsInteger = 5307) then
      ...
      writeln(F);
      writeln(F);
      if (tAuxEtiquetaCodigo.AsInteger <> 2675) and (tAuxEtiquetaCodigo.AsInteger <> 5307) then
        writeln(F);
    end
  else
    begin
