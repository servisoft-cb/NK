object fPrevRecCli: TfPrevRecCli
  ...
  Caption = 'Relatório de Contas a Receber p/ Cliente'
  ClientHeight = 182
  ClientWidth = 389
  Color = clBtnFace
  ...
  object qReceber: TQuery
    ...
    SQL.Strings = (
        ...
        'SELECT DISTINCT Dbcreceberparc.CodCli, SUM( Dbcreceberparc.RestP' +
        'arcela) RestParcela, SUM( Dbcreceberparc.VlrParcCReceber ) VlrPa' +
        'rcCReceber, SUM( Dbcreceberparc.Desconto ) Desconto, SUM( Dbcrec' +
        'eberparc.Abatimentos ) Abatimentos,  Dbcliente.Nome'
    ...
    object qReceberRestParcela: TFloatField
