...
type
  TfRelCPagarCReceberRes = class(TForm)
    RLReport1: TRLReport;
...
var
  fRelCPagarCReceberRes: TfRelCPagarCReceberRes;
...
procedure TfRelCPagarCReceberRes.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := Cafree;
end;

procedure TfRelCPagarCReceberRes.RLBand1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
