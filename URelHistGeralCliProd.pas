...
type
  TfRelHistGeralCliProd = class(TForm)
    RLReport1: TRLReport;
...
var
  fRelHistGeralCliProd: TfRelHistGeralCliProd;
...
procedure TfRelHistGeralCliProd.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := Cafree;
end;

procedure TfRelHistGeralCliProd.RLBand1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TfRelHistGeralCliProd.RLBand3BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
