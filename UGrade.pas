...
uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs, Variants, ExtCtrls, DBCtrls, StdCtrls, Mask, Buttons, Db, DBTables, Grids, DBGrids,
  rsDBUtils, DBVGrids, RxLookup, ComCtrls;
...
begin
  ...
  if ((DM1.tGradeCodLetra.AsString <> '') or (DM1.tGradeCodLetra.AsString <> '')) and (BitBtn2.Tag = 0) then
    begin
      if tGradeIns.Locate('CodLetra;Largura', VarArrayOf([DM1.tGradeCodLetra.AsString,DM1.tGradeLargura.AsString]),[loPartialKey]) then
        begin
          vGravar := 'N';
