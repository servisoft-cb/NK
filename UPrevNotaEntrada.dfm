object fPrevNotaEntrada: TfPrevNotaEntrada
  ...
  object qNotaEntrada: TQuery
    ...
    SQL.Strings = (
        ...
        'SELECT Dbnentrada.NumNEntr, Dbnentradaitens.CodMaterial, DbProdu' +
        'to.Nome Material, Dbcor.Nome Cor, Dbnentradaitens.Qtd, Dbnentrad' +
        'aitens.VlrUnit, Dbnentrada.VlrTotalNEntr, Dbnentrada.CodForn, Db' +
        'nentrada.DtEntrada, Dbfornecedores.NomeForn, DbNEntradaItens.Ite' +
        'm, DbNEntradaItens.VlrTotalItens'
