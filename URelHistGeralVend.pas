...
type
  TfRelHistGeralVend = class(TForm)
    RLReport1: TRLReport;
...
var
  fRelHistGeralVend: TfRelHistGeralVend;
...
procedure TfRelHistGeralVend.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := Cafree;
end;

procedure TfRelHistGeralVend.RLBand1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  RLLabel1.Caption := 'Relatório de Faturamento por Vendedor';
...
procedure TfRelHistGeralVend.RLBand3BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
