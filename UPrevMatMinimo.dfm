object fPrevMatMinimo: TfPrevMatMinimo
  ...
  Caption = 'Relatório de Materiais Abaixo do Mínimo'
  ClientHeight = 89
  ClientWidth = 302
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Panel2: TPanel
      ...
      object RxSpeedButton1: TRxSpeedButton
        ...
        Width = 100
        Height = 25
        Hint = 'Imprime relação de materiais c/ saldo abaixo do mínimo'
        Caption = 'Imprimir'
        Glyph.Data = {
  ...
  object qEstoque: TQuery
    ...
    SQL.Strings = (
        ...
        'ia, Dbcor.Nome NomeCor, SUM( Dbestoquematmov.Qtd2 ) Saldo'
