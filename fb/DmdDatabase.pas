...
begin
  ...
  try
    scoDados.Params.Values['DATABASE'] := Config.ReadString('NK', 'DATABASE', '');
    scoDados.Params.Values['USER_NAME'] := Config.ReadString('NK', 'USERNAME', '');
    scoDados.Params.Values['PASSWORD'] := Decoder64.DecodeString(Config.ReadString('NK', 'PASSWORD', ''));
